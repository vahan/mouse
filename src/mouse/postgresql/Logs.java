...
public class Logs extends DbTable {
	...
	protected String[] insertFields() {
		String[] fields = new String[] { "first_reading", "last_reading",
				"duration", "imported_at", "nb_readings", "size" };
		return fields;
	}
	...
	protected String[] insertValues(DbTableRow model) {
		...
		String[] values = new String[] { "'" + log.getFirstReading() + "'",
				"'" + log.getLastReading() + "'",
	...
	protected void initColumns() {
		...
		columns.put("imported_at", new DbEntry("imported_at",
				ColumnTypes.timestamp, ""));
		columns.put("nb_readings", new DbEntry("nb_readings",
				ColumnTypes.integer, ""));
