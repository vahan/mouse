...
public class MeetingResults extends DbDynamicTable {
	...
	public MeetingResults() {
		super("meeting_results");

	}

	/**
	 * Make sure to call this method before accessing the minDuration and
	 * maxDuration members
	 * 
	 * @param durationLeft
	 * @param durationRight
	...
	protected String[] insertFields() {
		String[] fields = new String[] { "trans_from_id", "trans_to_id",
				"start", "stop", "duration", "terminated_by", "box_id" };
		return fields;
	}
	...
	protected void initColumns() {
		...
		columns.put("trans_from_id", new DbEntry("trans_from_id",
				ColumnTypes.integer, "references transponders(id)"));
		columns.put("trans_to_id", new DbEntry("trans_to_id",
				ColumnTypes.integer, "references transponders(id)"));
		...
		columns.put("terminated_by", new DbEntry("terminated_by",
				ColumnTypes.integer, ""));
